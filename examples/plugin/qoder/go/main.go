	...
	return registration{
		...
		Metadata: pluginapi.Metadata{
			...
			ConfigFields: []pluginapi.ConfigField{
				...
				{Name: "direct_catalog_format", Type: pluginapi.ConfigFieldTypeEnum, EnumValues: []string{"openai", "qoder"}, Description: "Catalog wire format: qoder uses COSY and the enabled chat scene; openai uses Bearer and data/models arrays. Defaults to qoder. Explicit direct_models keeps precedence."},
				...
				{Name: "direct_token_mode", Type: pluginapi.ConfigFieldTypeEnum, EnumValues: []string{"auto", "bearer", "pat_exchange"}, Description: "Direct credential mode; auto exchanges pt- PATs and bearer passes opaque access_token values through."},
				{Name: "openapi_endpoint", Type: pluginapi.ConfigFieldTypeString, Description: "Qoder OpenAPI base used for PAT exchange and account/plan/quota queries; defaults to the China-zone OpenAPI base. Never put a token in this URL."},
				...
				{Name: "request_timeout", Type: pluginapi.ConfigFieldTypeString, Description: "Native control request timeout."},
