...
func (s *Server) registerManagementRoutes() {
	...
	mgmt.Use(s.managementAvailabilityMiddleware(), s.mgmt.Middleware())
	{
		...
		mgmt.GET("/usage/query/capabilities", s.mgmt.GetUsageQueryCapabilities)
		mgmt.POST("/usage/query/summary", s.mgmt.QueryUsageSummary)
		mgmt.POST("/usage/query/details", s.mgmt.QueryUsageDetails)
		mgmt.POST("/usage/query/pricing", s.mgmt.QueryUsagePricing)
		mgmt.GET("/usage-queue", s.mgmt.GetUsageQueue)
		mgmt.GET("/config", s.mgmt.GetConfig)
		mgmt.GET("/flow-control", s.mgmt.GetFlowControl)
		mgmt.GET("/flow-control/events", s.mgmt.GetFlowControlEvents)
		mgmt.GET("/flow-control/explain", s.mgmt.ExplainFlowControl)
		mgmt.GET("/flow-control/summary", s.mgmt.GetFlowControlSummary)
		mgmt.GET("/flow-control/details", s.mgmt.GetFlowControlDetails)
		mgmt.POST("/flow-control/preview", s.mgmt.PreviewFlowControl)
		mgmt.POST("/flow-control/migration-preview", s.mgmt.PreviewFlowControlMigration)
