...
func TestParseClaudeStreamUsage_MessageStart(t *testing.T) {
	...
	if detail.InputTokens != 2095+355598+7185 {
		t.Errorf("inclusive input tokens = %d, want 364878", detail.InputTokens)
	}
...
func TestStreamUsageBufferObserveClaudeStream_MergesStartAndDelta(t *testing.T) {
	...
	if detail.InputTokens != 2095+355598+7185 {
		t.Errorf("inclusive InputTokens = %d, want 364878", detail.InputTokens)
	}
...
func TestStreamUsageBufferObserveClaudeStream_FailurePreservesUsage(t *testing.T) {
	...
	if record.Detail.InputTokens != 2095+355598+7185 {
		t.Errorf("inclusive InputTokens = %d, want 364878", record.Detail.InputTokens)
	}
