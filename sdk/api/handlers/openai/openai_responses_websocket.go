...
type responsesWebsocketInboundMessage = cliproxyexecutor.WebsocketInput
...
func pumpResponsesWebsocketReads(
	...
	for {
		...
		message := responsesWebsocketInboundMessage{Payload: payload}
		select {
